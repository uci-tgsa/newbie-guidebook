...
requestAnimationFrame(function(){self.fire("app-reset-layout")})},_notifyDescendantResize:function _notifyDescendantResize(){if(!this.isAttached){return}this._interestedResizables.forEach(function(resizable){if(this.resizerShouldNotify(resizable)){this._notifyDescendant(resizable)}},this)}}];_exports.AppLayoutBehavior=AppLayoutBehavior;var appLayoutBehavior={AppLayoutBehavior:AppLayoutBehavior};_exports.$appLayoutBehavior=appLayoutBehavior;Polymer({_template:html(_templateObject_0fe26e5084b711e98c3fc7fd73e5d641()),is:"app-drawer-layout",behaviors:[AppLayoutBehavior],properties:{/**
...
// opened state.
afterNextRender(this,function(){drawer.removeAttribute("no-transition")})}this._drawerNeedsReset=!1}},_narrowChanged:function _narrowChanged(){this._drawerNeedsReset=!0;this.resetLayout()},_onQueryMatchesChanged:function _onQueryMatchesChanged(event){this._setNarrow(event.detail.value)},_computeMediaQuery:function _computeMediaQuery(forceNarrow,responsiveWidth){return forceNarrow?"(min-width: 0px)":"(max-width: "+responsiveWidth+")"}});var template=html(_templateObject2_0fe26e5084b711e98c3fc7fd73e5d641());template.setAttribute("style","display: none;");document.head.appendChild(template.content);var style=document.createElement("style");style.textContent="[hidden] { display: none !important; }";document.head.appendChild(style);Polymer({_template:html(_templateObject3_0fe26e5084b711e98c3fc7fd73e5d641()),is:"app-drawer",properties:{/**
...
// align setting is ok.
if(0>diff||0===diff&&(vAlignOk||hAlignOk)){position=candidate}}return position}};_exports.IronFitBehavior=IronFitBehavior;var ironFitBehavior={IronFitBehavior:IronFitBehavior};_exports.$ironFitBehavior=ironFitBehavior;var template$1=html(_templateObject8_0fe26e5084b711e98c3fc7fd73e5d641());template$1.setAttribute("style","display: none;");document.head.appendChild(template$1.content);var IronMeta=/*#__PURE__*/function(){/**
   * @param {{
...
IronMeta[" "]=function(){};IronMeta.types={};var metaDatas=IronMeta.types;/**
   ...
   * @return {*}
   */byKey:function byKey(key){return new IronMeta({type:this.type,key:key}).value}});var ironMeta={IronMeta:IronMeta};_exports.$ironMeta=ironMeta;Polymer({_template:html(_templateObject9_0fe26e5084b711e98c3fc7fd73e5d641()),is:"iron-icon",properties:{/**
...
// shadow-root
svg.style.cssText=cssText;svg.appendChild(content).removeAttribute("id");return svg}return null}});var template$2=html(_templateObject10_0fe26e5084b711e98c3fc7fd73e5d641());document.head.appendChild(template$2.content);var p$1=Element.prototype,matches$1=p$1.matches||p$1.matchesSelector||p$1.mozMatchesSelector||p$1.msMatchesSelector||p$1.oMatchesSelector||p$1.webkitMatchesSelector,IronFocusablesHelper={/**
...
// e.g. in Firefox `<div contenteditable>` has `tabIndex = -1`
var ati=Math.max(a.tabIndex,0),bti=Math.max(b.tabIndex,0);return 0===ati||0===bti?bti>ati:ati>bti}};_exports.IronFocusablesHelper=IronFocusablesHelper;var ironFocusablesHelper={IronFocusablesHelper:IronFocusablesHelper};_exports.$ironFocusablesHelper=ironFocusablesHelper;Polymer({_template:html(_templateObject11_0fe26e5084b711e98c3fc7fd73e5d641()),is:"iron-overlay-backdrop",properties:{/**
...
window.marked=marked$1}Polymer({_template:html(_templateObject13_0fe26e5084b711e98c3fc7fd73e5d641()),is:"marked-element",properties:{/**
...
if(0===status||200<=status&&300>status){this.sanitize=!this.disableRemoteSanitization;this.markdown=e.target.response}else{this._handleError(e)}this.fire("marked-loadend",e)}.bind(this));xhr.open("GET",url);xhr.setRequestHeader("Accept","text/markdown");xhr.send()},/**
   ...
   */_onScriptAttributeChanged:function _onScriptAttributeChanged(mutation){if("src"!==mutation[0].attributeName){return}this._request(this._markdownElement.src)}});var NeonAnimatableBehavior={properties:{/**
...
this.waveContainer.style.webkitTransform="translate("+dx+"px, "+dy+"px)";this.waveContainer.style.transform="translate3d("+dx+"px, "+dy+"px, 0)";this.wave.style.webkitTransform="scale("+scale+","+scale+")";this.wave.style.transform="scale3d("+scale+","+scale+",1)"},/** @param {Event=} event */downAction:function downAction(event){var xCenter=this.containerMetrics.width/2,yCenter=this.containerMetrics.height/2;this.resetInteractionState();this.mouseDownStart=Utility.now();if(this.center){this.xStart=xCenter;this.yStart=yCenter;this.slideDistance=Utility.distance(this.xStart,this.yStart,this.xEnd,this.yEnd)}else{this.xStart=event?event.detail.x-this.containerMetrics.boundingRect.left:this.containerMetrics.width/2;this.yStart=event?event.detail.y-this.containerMetrics.boundingRect.top:this.containerMetrics.height/2}if(this.recenters){this.xEnd=xCenter;this.yEnd=yCenter;this.slideDistance=Utility.distance(this.xStart,this.yStart,this.xEnd,this.yEnd)}this.maxRadius=this.containerMetrics.furthestCornerDistanceFrom(this.xStart,this.yStart);this.waveContainer.style.top=(this.containerMetrics.height-this.containerMetrics.size)/2+"px";this.waveContainer.style.left=(this.containerMetrics.width-this.containerMetrics.size)/2+"px";this.waveContainer.style.width=this.containerMetrics.size+"px";this.waveContainer.style.height=this.containerMetrics.size+"px"},/** @param {Event=} event */upAction:function upAction(event){if(!this.isMouseDown){return}this.mouseUpStart=Utility.now()},remove:function remove(){dom(this.waveContainer.parentNode).removeChild(this.waveContainer)}};/**
   ...
   @hero hero.svg
   @demo demo/index.html
   */Polymer({_template:html(_templateObject14_0fe26e5084b711e98c3fc7fd73e5d641()),is:"paper-ripple",behaviors:[IronA11yKeysBehavior],properties:{/**
...
for(var path=dom(event).path,i=0,l=path.indexOf(this),target;i<l;i++){target=path[i];if(target.hasAttribute&&(target.hasAttribute("dialog-dismiss")||target.hasAttribute("dialog-confirm"))){this._updateClosingReasonConfirmed(target.hasAttribute("dialog-confirm"));this.close();event.stopPropagation();break}}}};/** @polymerBehavior */_exports.PaperDialogBehaviorImpl=PaperDialogBehaviorImpl;var PaperDialogBehavior=[IronOverlayBehavior,PaperDialogBehaviorImpl];_exports.PaperDialogBehavior=PaperDialogBehavior;var paperDialogBehavior={PaperDialogBehaviorImpl:PaperDialogBehaviorImpl,PaperDialogBehavior:PaperDialogBehavior};_exports.$paperDialogBehavior=paperDialogBehavior;var template$6=html(_templateObject18_0fe26e5084b711e98c3fc7fd73e5d641());template$6.setAttribute("style","display: none;");document.head.appendChild(template$6.content);var template$7=html(_templateObject19_0fe26e5084b711e98c3fc7fd73e5d641());template$7.setAttribute("style","display: none;");document.head.appendChild(template$7.content);var template$8=html(_templateObject20_0fe26e5084b711e98c3fc7fd73e5d641());template$8.setAttribute("style","display: none;");document.head.appendChild(template$8.content);var $_documentContainer$1=document.createElement("template");$_documentContainer$1.setAttribute("style","display: none;");$_documentContainer$1.innerHTML="<dom-module id=\"paper-dialog-shared-styles\">\n  <template>\n    <style>\n      :host {\n        display: block;\n        margin: 24px 40px;\n\n        background: var(--paper-dialog-background-color, var(--primary-background-color));\n        color: var(--paper-dialog-color, var(--primary-text-color));\n\n        @apply --paper-font-body1;\n        @apply --shadow-elevation-16dp;\n        @apply --paper-dialog;\n      }\n\n      :host > ::slotted(*) {\n        margin-top: 20px;\n        padding: 0 24px;\n      }\n\n      :host > ::slotted(.no-padding) {\n        padding: 0;\n      }\n\n      \n      :host > ::slotted(*:first-child) {\n        margin-top: 24px;\n      }\n\n      :host > ::slotted(*:last-child) {\n        margin-bottom: 24px;\n      }\n\n      /* In 1.x, this selector was `:host > ::content h2`. In 2.x <slot> allows\n      to select direct children only, which increases the weight of this\n      selector, so we have to re-define first-child/last-child margins below. */\n      :host > ::slotted(h2) {\n        position: relative;\n        margin: 0;\n\n        @apply --paper-font-title;\n        @apply --paper-dialog-title;\n      }\n\n      /* Apply mixin again, in case it sets margin-top. */\n      :host > ::slotted(h2:first-child) {\n        margin-top: 24px;\n        @apply --paper-dialog-title;\n      }\n\n      /* Apply mixin again, in case it sets margin-bottom. */\n      :host > ::slotted(h2:last-child) {\n        margin-bottom: 24px;\n        @apply --paper-dialog-title;\n      }\n\n      :host > ::slotted(.paper-dialog-buttons),\n      :host > ::slotted(.buttons) {\n        position: relative;\n        padding: 8px 8px 8px 24px;\n        margin: 0;\n\n        color: var(--paper-dialog-button-color, var(--primary-color));\n\n        @apply --layout-horizontal;\n        @apply --layout-end-justified;\n      }\n    </style>\n  </template>\n</dom-module>";document.head.appendChild($_documentContainer$1.content);Polymer({_template:html(_templateObject21_0fe26e5084b711e98c3fc7fd73e5d641()),is:"paper-dialog-scrollable",properties:{/**
...
if(this.dialogElement&&this.dialogElement.behaviors&&0<=this.dialogElement.behaviors.indexOf(PaperDialogBehaviorImpl)){this.dialogElement.sizingTarget=this.scrollTarget;this.scrollTarget.classList.remove("fit")}else if(this.dialogElement){this.scrollTarget.classList.add("fit")}}});Polymer({_template:html(_templateObject22_0fe26e5084b711e98c3fc7fd73e5d641()),is:"paper-dialog",behaviors:[PaperDialogBehavior,NeonAnimationRunnerBehavior],listeners:{"neon-animation-finish":"_onNeonAnimationFinish"},_renderOpened:function _renderOpened(){this.cancelAnimation();this.playAnimation("entry")},_renderClosed:function _renderClosed(){this.cancelAnimation();this.playAnimation("exit")},_onNeonAnimationFinish:function _onNeonAnimationFinish(){if(this.opened){this._finishRenderOpened()}else{this._finishRenderClosed()}}});Polymer({is:"paper-icon-button",_template:html(_templateObject23_0fe26e5084b711e98c3fc7fd73e5d641()),hostAttributes:{role:"button",tabindex:"0"},behaviors:[PaperInkyFocusBehavior],registered:function registered(){this._template.setAttribute("strip-whitespace","")},properties:{/**
...
if(4===xhr.readyState){request.signal.removeEventListener("abort",abortXhr)}}}xhr.send("undefined"===typeof request._bodyInit?null:request._bodyInit)})}fetch.polyfill=!0;if(!self.fetch){self.fetch=fetch;self.Headers=Headers;self.Request=Request;self.Response=Response}var fetch$1={Headers:Headers,Request:Request,Response:Response,get DOMException(){return DOMException},fetch:fetch};_exports.$fetch=fetch$1;var $_documentContainer$2=document.createElement("template");$_documentContainer$2.innerHTML="<dom-module id=\"shared-styles\">\n  <template>\n    <style>\n      .card {\n        padding: 16px;\n        color: #757575;\n        border-radius: 5px;\n        background-color: #fff;\n        box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 1px 5px 0 rgba(0, 0, 0, 0.12), 0 3px 1px -2px rgba(0, 0, 0, 0.2);\n      }\n\n      .circle {\n        display: inline-block;\n        width: 64px;\n        height: 64px;\n        text-align: center;\n        color: #555;\n        border-radius: 50%;\n        background: #ddd;\n        font-size: 30px;\n        line-height: 64px;\n      }\n    </style>\n  </template>\n</dom-module>";document.head.appendChild($_documentContainer$2.content);// preventable, allowing for better scrolling performance.
setPassiveTouchGestures(!0);// Set Polymer's root path to the same value we passed to our service worker
// in `index.html`.
setRootPath(MyAppGlobals.rootPath);var ShellPage=/*#__PURE__*/function(_PolymerElement2){babelHelpers.inherits(ShellPage,_PolymerElement2);function ShellPage(){babelHelpers.classCallCheck(this,ShellPage);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ShellPage).apply(this,arguments))}babelHelpers.createClass(ShellPage,[{key:"_routePageChanged",value:function _routePageChanged(page){// Show the corresponding page according to the route.
//
// If no page was found in the route data, page will be an empty string.
// Show 'view1' in that case. And if the page doesn't exist, show 'view404'.
if(!page){this.page="landing"}else if(-1!==["tldr","food","landing","housing"].indexOf(page)){this.page=page}else{this.page="view404"}// Close a non-persistent drawer when the page & route are changed.
...
switch(page){case"landing":new Promise(function(res,rej){return _require.default(["./landing-page.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$landingPage||{}});break;case"tldr":new Promise(function(res,rej){return _require.default(["./tldr-page.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$tldrPage||{}});break;case"food":new Promise(function(res,rej){return _require.default(["./food-page.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$foodPage||{}});break;case"housing":new Promise(function(res,rej){return _require.default(["./housing-page.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$housingPage||{}});break;case"view404":new Promise(function(res,rej){return _require.default(["./my-view404.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$myView404||{}});break;}}},{key:"_computeIsBeta",value:function _computeIsBeta(beta){return"true"===beta}}],[{key:"template",get:function get(){return html(_templateObject24_0fe26e5084b711e98c3fc7fd73e5d641())}},{key:"properties",get:function get(){return{page:{type:String,reflectToAttribute:!0,observer:"_pageChanged"},routeData:Object,subroute:Object,_queryParams:Object,_isBeta:{type:Boolean,computed:"_computeIsBeta(_queryParams.beta)"}}}},{key:"observers",get:function get(){return["_routePageChanged(routeData.page)"]}}]);return ShellPage}(PolymerElement);window.customElements.define("shell-page",ShellPage)});